...
public class HrefActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.init(new RefreshPostListener(), R.layout.post_item, new String[] { "au", "pt", "ttl", "sn", "pv",
				"clk", "mrk" }, new int[] { R.id.author_name, R.id.post_time, R.id.post_title, R.id.post_source,
